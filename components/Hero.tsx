    ...
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        {isClient && (
          <>
            ...
            <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-secondary/20 rounded-full blur-3xl animate-pulse animation-delay-2000"></div>
            <div className="absolute top-1/2 right-0 w-96 h-96 bg-accent/10 rounded-full blur-3xl animate-pulse animation-delay-4000"></div>
          </>
        )}
        ...
        <div className="absolute inset-0 bg-radial-gradient" style={{backgroundImage: 'radial-gradient(circle at 50% 50%, rgba(0, 102, 204, 0.1), transparent 70%)'}}></div>
      </div>
      ...
      <div className="relative z-10 container-wide text-center section-padding">
        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold mb-6 leading-tight text-white drop-shadow-lg">
          JD Dental Lab
          <span className="block text-transparent bg-clip-text bg-gradient-to-r from-primary via-secondary to-accent mt-2 drop-shadow-lg">
            Global Innovation
          </span>
        </h1>
        <p className="text-lg sm:text-xl text-gray-200 max-w-3xl mx-auto mb-8 drop-shadow-md">
